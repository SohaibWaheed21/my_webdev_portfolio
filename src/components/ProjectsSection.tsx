          ...
          {projects.map((project) => (
            ...
            >
              <div className="md:col-span-1">
                <span className="font-display text-xs text-muted-foreground group-hover:text-primary-foreground">
                  {project.id}
                </span>
              </div>
              ...
              <div className="md:col-span-2">
                <p className="font-body text-xs uppercase tracking-widest text-muted-foreground group-hover:text-primary-foreground/70">
                  {project.tech}
                </p>
              </div>
